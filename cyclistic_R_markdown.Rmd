---
title: "Cyclistic Bike-Share Analysis:<br>Usage Patterns of Non-members vs. Members"
...
The resulting files ([Github repo](https://github.com/briancox-c/Cyclistic) | [Box parent folder](https://app.box.com/s/ohes059e27dnedakt147zcyayikpggyv)) include:\

- R markdown - [Github] | [Box]
- R script - [Github](https://github.com/briancox-c/Cyclistic/blob/main/cyclistic_R_script.R) | [Box](https://app.box.com/s/0jmubg01c2p8eoinjtzaz0iq45vcutld)
- SQL script - [Github](https://github.com/briancox-c/Cyclistic/blob/main/cyclistic_SQL.sql) | [BigQuery](https://console.cloud.google.com/bigquery?sq=975725981649:07826d28c3dc41a789ad77b36d5f6b5a) | [Box](https://app.box.com/s/im7wen2y1jjdebrx924ahdgp0gell4rs)
- Tableau static story - [Tableau Public](https://public.tableau.com/views/CyclisticStatic/Cyclistic?:language=en-US&:sid=&:display_count=n&:origin=viz_share_link)
\

# Data

The dataset consists of .csv files covering the 5.7 million Cyclistic trips taken in 2023. Each record is an observation of one trip.  The data are open and are available [here](https://app.box.com/s/pmz7b6zl4h5n0exnawnwxhpvkuaw0hou)
...
- [Box](https://app.box.com/s/ohes059e27dnedakt147zcyayikpggyv) | All code, source data (in the "monthly" folder), and cleaned and generated data (in the "yearly" folder)\

- [BigQuery](https://console.cloud.google.com/bigquery?sq=975725981649:07826d28c3dc41a789ad77b36d5f6b5a)\

- [Tableau Public](https://public.tableau.com/views/CyclisticStatic/Cyclistic?:language=en-US&:sid=&:display_count=n&:origin=viz_share_link) | Tableau story\
\
